  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-16 text-center">
      ...
      <p className="mb-10 text-lg text-muted-foreground">
        Lies den Quran mit Wort-für-Wort deutscher Übersetzung, speichere Vokabeln und
      ...
      {/* Surah cards */}
      <h3 className="mb-4 text-lg font-semibold text-foreground">Verfügbare Suren</h3>
        ...
        {AVAILABLE_SURAHS.map((surah) => (
          ...
          >
            ...
            <div className="mt-3">
              ...
              <p className="text-sm text-muted-foreground">{surah.verses_count} Verse</p>
            </div>
          </Link>
        ))}
      </div>
      ...
      <div className="mt-16 grid gap-6 text-left sm:grid-cols-3">
        <div className="rounded-xl border border-border bg-card p-5">
          ...
          <h4 className="mb-1 font-semibold text-foreground">Wort-für-Wort</h4>
          <p className="text-sm text-muted-foreground">
            Klicke auf jedes arabische Wort, um die Übersetzung zu sehen und es zu speichern.
          </p>
        </div>
        <div className="rounded-xl border border-border bg-card p-5">
          <div className="mb-2 text-2xl">🔊</div>
          <h4 className="mb-1 font-semibold text-foreground">Audio-Wiedergabe</h4>
          <p className="text-sm text-muted-foreground">
            Höre jeden Vers mit Wort-Hervorhebung an.
          </p>
        </div>
        <div className="rounded-xl border border-border bg-card p-5">
          <div className="mb-2 text-2xl">🃏</div>
          <h4 className="mb-1 font-semibold text-foreground">Karteikarten</h4>
          <p className="text-sm text-muted-foreground">
            Übe deine gespeicherten Vokabeln mit Karteikarten.
          </p>
        </div>
      </div>
    </div>
