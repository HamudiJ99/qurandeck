  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-8">
      ...
      <div className="mb-8">
        ...
        <p className="mt-2 text-muted-foreground">{t("notes.subtitle")}</p>
      </div>
      ...
      {notes.length > 0 && (
        <div className="mb-6 flex flex-wrap items-center gap-3">
          ...
          <button
            ...
            className="rounded-lg border border-border bg-card px-3 py-2 text-sm text-foreground transition-colors hover:bg-muted"
          >
      ...
      {notesLoading ? (
        ...
        <div className="rounded-2xl border border-border bg-card p-12 text-center">
          ...
          <p className="mt-4 text-muted-foreground">{t("notes.empty")}</p>
          <Link
            href="/quran"
                      ...
                      <div>
                        ...
                        <div className="mt-4 flex items-center gap-2">
                          <button
                            ...
                            className="inline-flex items-center gap-1 rounded-lg px-3 py-2 text-sm font-medium text-primary transition-colors hover:bg-primary/10"
                          >
                          ...
                          {deleteConfirmId === note.id ? (
                            ...
                            <button
                              ...
                              className="inline-flex items-center gap-1 rounded-lg px-3 py-2 text-sm font-medium text-red-500 transition-colors hover:bg-red-50 dark:hover:bg-red-950"
                            >
                              <svg className="h-3.5 w-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
