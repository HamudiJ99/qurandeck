      ...
      <div className="w-full">
        {registered ? (
          ...
          <div className="text-center">
            <svg className="mx-auto mb-4 h-16 w-16 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
            </svg>
            <h1 className="text-2xl font-bold text-foreground">{t("auth.checkYourEmail")}</h1>
            <p className="mt-3 text-muted-foreground">{t("auth.verificationSentDesc")}</p>
            ...
            <p className="mt-4 text-xs text-muted-foreground">{t("auth.verifyLater")}</p>
          </div>
        ) : (
          /* ===== Registration form ===== */
          <div>
